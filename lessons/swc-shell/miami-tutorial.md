...
**Further Modified by Jonah Duckles**
...
command:
    ...
    git clone -b {{page.checkout_branch}} https://github.com/{{page.github_username}}/{{page.bootcamp_slug}}
...
directory) is used to move around. Let's move into the `~/{{page.bootcamp_slug}}`
...
Navigate to the `~/{{page.bootcamp_slug}}/day1.shell/data/THOMAS` directory. This
...
Navigate to the home directory (.../{{page.bootcamp_slug}}). Typing out directory names can waste a
...
`day1.shell`. Now enter:
    ...
    ls ~/{{page.bootcamp_slug}}/day1.shell/e<tab><tab>
...
because the directory `.../{{page.bootcamp_slug}}/day1.shell` is not in the
...
1.  Print out the contents of the `~/{{page.bootcamp_slug}}/day1.shell/dictionary.txt`
...
case. Enter the following command:
    ...
    less ~/{{page.bootcamp_slug}}/day1.shell/dictionary.txt
...
began with. This data is located in the `~/{{page.bootcamp_slug}}/day1.shell/data`
...
number 4 in the directory:
    ...
    ~/{{page.bootcamp_slug}}/day1.shell/data/gerdal
...
Let's navigate back to `~/{{page.bootcamp_slug}}/day1.shell/data`. Enter the following command:
